...
<body>
    <header class="navbar_main">
        ...
        <video autoplay muted loop class="video_back">
        ...
        <div class="navbar navbar-expand-lg navbar-dark pt-4" id="navbar">
            <div class="container-fluid px-2 px-lg-0">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarToggler">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link active text-light navbar-effect" aria-current="page" href="">Поддержка Drupal
                            </a>
                        </li>
    ...
    <div class="container team">
        <div class="row row-cols-2 row-cols-lg-3">
            <div class="col teamImage">
                <div>
                    <img src="img/IMG_2472_0.jpg" width="300" height="300" alt="Sinitza">
                    <h3>
                        Сергей Синица
                    </h3>
                    <p>
            ...
            <div class="col teamImage">
                <div>
                    <img src="img/IMG_2539_0.jpg" width="300" height="300" alt="Sinitza">
                    <h3>
                        Роман Агабеков
                    </h3>
                    <p>
            ...
            <div class="col teamImage">
                <div>
                    <img src="img/IMG_2474_1.jpg" width="300" height="300" alt="Sinitza">
                    <h3>
                        Алексей Синица
                    </h3>
                    <p>
            ...
            <div class="col teamImage">
                <div>
                    <img src="img/IMG_2522_0.jpg" width="300" height="300" alt="Sinitza">
                    <h3>
                        Дарья Бочкарёва
                    </h3>
                    <p>
            ...
            <div class="col teamImage">
                <div>
                    <img src="img/IMG_9971_16.jpg" width="300" height="300" alt="Sinitza">
                    <h3>
                        Ирина Торкунова
                    </h3>
                    <p>
    ...
    <div class="container-fluid workingWithCarouselWrapper">
        <div class="text-center">
          ...
          <div class="WorkingWithCarousel1 my-2" id="workingwithcarouselupper">
            <div class="workingwithInside"><img src="img/japantravel_ru.png" width="300" height="150"/></div>
            <div class="workingwithInside"><img src="img/ptkbik_ru.png" width="300" height="150"/></div>
            <div class="workingwithInside"><img src="img/ayurvedadom_com.png" width="300" height="150"/></div>
            <div class="workingwithInside"><img src="img/tbs_ru.jpg" width="300" height="150"/></div>
            <div class="workingwithInside"><img src="img/confirent_ru.png" width="300" height="150"/></div>
            <div class="workingwithInside"><img src="img/japantravel_ru.png" width="300" height="150"/></div>
            <div class="workingwithInside"><img src="img/ptkbik_ru.png" width="300" height="150"/></div>
            <div class="workingwithInside"><img src="img/ayurvedadom_com.png" width="300" height="150"/></div>
            <div class="workingwithInside"><img src="img/tbs_ru.jpg" width="300" height="150"/></div>
            <div class="workingwithInside"><img src="img/confirent_ru.png" width="300" height="150"/></div>
            <div class="workingwithInside"><img src="img/urheiluperhe_com.png" width="300" height="150"/></div>
            <div class="workingwithInside"><img src="img/megafurs_com.png" width="300" height="150"/></div>
            <div class="workingwithInside"><img src="img/ayurvedadom_com.png" width="300" height="150"/></div>
            <div class="workingwithInside"><img src="img/tbs_ru.jpg" width="300" height="150"/></div>
            <div class="workingwithInside"><img src="img/ptkbik_ru.png" width="300" height="150"/></div>
            <div class="workingwithInside"><img src="img/japantravel_ru.png" width="300" height="150"/></div>
